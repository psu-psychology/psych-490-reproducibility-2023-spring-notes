...
```{r, out.width="80%", fig.cap="High power poses. Figure 1 from [@Carney2010-gq](http://dx.doi.org/10.1177/0956797610383437)"}
knitr::include_graphics("include/img/carney-etal-fig01.png")
```

```{r, fig.cap="Low power poses. Figure 2 from [@Carney2010-gq](http://dx.doi.org/10.1177/0956797610383437)"}
...
```{r, out.width="80%", fig.cap="[@Carney2010-gq](http://dx.doi.org/10.1177/0956797610383437)"}
knitr::include_graphics("include/img/carney-etal-2010-results.png")
```

```{r, out.width="80%", fig.cap="Figure 3 from [@Carney2010-gq](http://dx.doi.org/10.1177/0956797610383437)"}
...
```{r, out.width="80%", fig.cap="Results excerpt from [@Ranehill2015-dj](http://dx.doi.org/10.1177/0956797614553946)"}
knitr::include_graphics("include/img/ranehill-etal-2015-results.png")
```

```{r, fig.cap="Figure 1 from [@Ranehill2015-dj](http://dx.doi.org/10.1177/0956797614553946)"}
...
```{r, out.width="80%", fig.cap="Open Science Framework site (https://osf.io/6akvt) for [@Ranehill2015-dj](http://dx.doi.org/10.1177/0956797614553946)"}
knitr::include_url("https://osf.io/6akvt")
```
